...
import static com.svedentsov.core.allure.AllureRestAssuredFilter.withCustomTemplates;
...
public class RestExecutor {
    ...
    /**
     * Десериализует тело HTTP-ответа в объект указанного класса и выполняет валидацию через EntityValidator.
     *
