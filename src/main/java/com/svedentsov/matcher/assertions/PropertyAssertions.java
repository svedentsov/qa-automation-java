...
public class PropertyAssertions {
    ...
    /**
     * Проверяет, что значение свойства равно ожидаемому.
     *
    ...
    /**
     * Проверяет, что значение свойства равно null.
     *
     * @param <T> тип проверяемого свойства
    ...
    /**
     * Проверяет, что значение свойства не равно null.
     *
     * @param <T> тип проверяемого свойства
    ...
    /**
     * Проверяет, что значение свойства (строка или коллекция или карта) пустое.
     *
     * @param <T> тип проверяемого свойства
    ...
    /**
     * Проверяет, что значение свойства (строка, коллекция, карта или массив) не пустое.
     *
     * @param <T> тип проверяемого свойства
    ...
    /**
     * Проверяет, что значение имеет точный тип {@code expectedType}.
     *
    ...
    /**
     * Проверяет, что значение не имеет точный тип {@code expectedType}.
     *
     * @param expectedType ожидаемый тип значения
     * @param <T>          тип проверяемого свойства
     * @return условие проверки типа (строгое сравнение классов)
    ...
    /**
     * Проверяет, что значение является экземпляром (или подклассом) указанного типа.
     *
    ...
    /**
     * Проверяет, что значение не является экземпляром (или подклассом) указанного типа.
     *
     * @param type ожидаемый класс или интерфейс
     * @param <T>  тип проверяемого свойства
     * @return условие проверки принадлежности к типу
    ...
    /**
     * Проверяет, что значение является подклассом или реализует указанный тип.
     *
    ...
    /**
     * Проверяет, что значение входит в заданный список.
     *
    ...
    /**
     * Проверяет, что значение не входит в заданный список.
     *
    ...
    /**
     * Проверяет, что значение находится в диапазоне между lowerBound и upperBound (включительно).
     *
    ...
    /**
     * Проверяет, что строковое представление значения равно ожидаемому.
     *
    ...
    /**
     * Проверяет, что строковое представление значения соответствует заданному регулярному выражению.
     *
    ...
    /**
     * Проверяет, что строка содержит заданную подстроку, игнорируя регистр.
     *
    ...
    /**
     * Проверяет, что значение удовлетворяет заданному предикату.
     *
    ...
    /**
     * Проверяет, что значение свойства соответствует заданному Hamcrest Matcher.
     *
    ...
    /**
     * Проверяет, что значение свойства НЕ соответствует заданному Hamcrest Matcher.
     *
     * @param matcher Matcher для проверки значения
     * @param <T>     тип проверяемого свойства
