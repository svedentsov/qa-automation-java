...
public class NumberAssertions {
    ...
    /**
     * Проверяет, что число равно нулю, алиас для numberIsZero().
     *
     * @param <T> тип числа
     * @return условие "равно 0"
     */
    ...
    /**
     * Проверяет, что число находится в полуоткрытом диапазоне [min, max) для чисел с плавающей точкой (через doubleValue()).
     *
