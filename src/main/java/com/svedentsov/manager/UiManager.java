...
import com.svedentsov.ui.pages.theinternet.*;
import lombok.NoArgsConstructor;
import com.svedentsov.steps.common.UiSteps;
...
public class UiManager {
    ...
    public static synchronized UiManager getManager() {
        return Optional.ofNullable(uiManager).orElseGet(() -> uiManager = new UiManager());
    }

    public UiSteps steps() {
        return Optional.ofNullable(uiSteps).orElseGet(() -> uiSteps = new UiSteps());
    }
