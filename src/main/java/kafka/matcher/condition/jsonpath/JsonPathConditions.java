...
/**
 * Утилитный класс для создания {@link JsonPathCondition}.
 * Все методы возвращают лямбда-выражения типа {@link JsonPathCondition}, которые можно применять к значениям, извлеченным из JSON по JsonPath.
 */
@UtilityClass
