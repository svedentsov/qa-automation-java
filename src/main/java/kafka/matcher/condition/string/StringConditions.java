...
/**
 * Утилитный класс для создания строковых условий {@link StringCondition}.
 * Все методы возвращают лямбда-выражения типа {@link StringCondition}, которые можно применять к строкам.
 */
@UtilityClass
