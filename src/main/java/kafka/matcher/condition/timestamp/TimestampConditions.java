...
/**
 * Утилитный класс для создания условий {@link TimestampCondition}.
 * Все методы возвращают лямбда-выражения типа {@link TimestampCondition}, которые можно применять к временным меткам.
 */
@UtilityClass
public final class TimestampConditions {
